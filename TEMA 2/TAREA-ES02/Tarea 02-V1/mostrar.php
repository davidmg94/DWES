...
<body>
    ...
    if (!file_exists($file) || filesize($file) == 0) {
        // Almacena un mensaje de información en la sesión y redirige a "index.php"
    ...
    <!-- Agrega un salto de línea y un enlace para volver a "index.php" -->
    <br>
    <div style="text-align:center">
        <a href="index.php">Volver a Tarea 02</a>
    </div>
</body>
